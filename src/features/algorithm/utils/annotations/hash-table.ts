...
export const hashTableAnnotations: Record<string, CodeAnnotation[][]> = {
  typescript: [
    ...
    // 여섯 번째 예제: Linear Probing 기법으로 충돌 해결
    [
      {
        line: 192,
        comment:
