  ...
  typescript: [
    ...
    [
      {
        line: 12,
        comment:
          'parent 함수: 자식 노드의 인덱스로부터 부모 노드의 인덱스를 반환하는 헬퍼 함수입니다. Math.floor((자식 인덱스 - 1) / 2)를 사용합니다.',
      },
      {
        line: 16,
        comment:
          'leftChild 함수: 부모 노드의 인덱스로부터 왼쪽 자식 노드의 인덱스를 반환하는 헬퍼 함수입니다. 부모 인덱스 * 2 + 1이 왼쪽 자식 인덱스입니다.',
      },
      {
        line: 20,
        comment:
    ...
    [
      ...
      },
      {
        line: 44,
        comment:
          'smallest 변수: 현재 노드와 자식 노드 중 가장 작은 값을 가진 노드의 인덱스를 저장합니다. 초기값은 현재 노드의 인덱스입니다.',
      },
      {
        line: 48,
        comment:
