...
export const linkedListAnnotations: Record<string, CodeAnnotation[][]> = {
  typescript: [
    ...
    // 네 번째 예제: 링크드 리스트 데이터 사이에 데이터를 추가
    [
      {
        line: 11,
        comment:
    ...
    // 다섯 번째 예제: 객체지향 프로그래밍으로 링크드 리스트 구현
    [
      {
        line: 160,
        comment:
    ...
    // 여덟 번째 예제: 더블 링크드 리스트 head/tail에서 검색
    [
      {
        line: 416,
        comment:
    ...
    // 아홉 번째 예제: 더블 링크드 리스트 특정 노드 앞에 데이터 추가
    [
      {
        line: 535,
        comment:
    ...
    // 열 번째 예제: 더블 링크드 리스트 특정 노드 뒤에 데이터 추가
    [
      {
        line: 656,
        comment:
    ...
    // 열한 번째 예제: 깔끔하게 정리된 LinkedList 구현
    [
      {
        line: 718,
        comment:
    ...
    // 열두 번째 예제: 깔끔하게 정리된 DoublyLinkedList 구현
    [
      {
        line: 887,
        comment:
