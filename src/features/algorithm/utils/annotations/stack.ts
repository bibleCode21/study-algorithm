...
// 각 코드 예제별 해석 배열
export const stackAnnotations: LanguageAnnotations = {
  typescript: [
    // 첫 번째 예제: 기본 스택 구현 (1-41줄)
    [
      {
        line: 2,
        comment:
      ...
      },
      {
        line: 36,
        comment:
          'LIFO 동작 확인: pop()을 호출하면 가장 나중에 추가된 요소(3)가 먼저 제거됩니다. 이것이 LIFO 구조의 특징입니다.',
      },
    ],
    // 두 번째 예제: 재귀 함수와 프로세스 스택 (1-29줄)
    [
      {
        line: 4,
        comment:
    ...
    [
      ...
      },
      {
        line: 13,
        comment:
          '빈 배열 체크: 스택이 비어있는지 확인합니다. 비어있으면 undefined를 반환합니다.',
      },
      {
        line: 16,
        comment:
