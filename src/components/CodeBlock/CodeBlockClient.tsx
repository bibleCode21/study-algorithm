...
const CodeBlockClient = ({
    ...
    return (
        <div className={`bg-gray-900 rounded-lg overflow-hidden ${className}`}>
            ...
            <div
                className="p-4 overflow-x-auto [&_pre]:!bg-transparent [&_pre]:!p-0 [&_pre]:!m-0 [&_code]:!text-xs md:[&_code]:!text-sm [&_code]:!font-mono [&_code]:!leading-relaxed [&_code]:!block [&_.line]:!block"
